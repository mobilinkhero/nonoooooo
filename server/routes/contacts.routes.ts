...
export function registerContactRoutes(app: Express) {
  ...
  // Contact Notes
  app.get("/api/contacts/:id/notes", requireAuth, requirePermission(PERMISSIONS.CONTACTS_VIEW), contactsController.getContactNotes);
  app.post("/api/contacts/:id/notes", requireAuth, requirePermission(PERMISSIONS.CONTACTS_EDIT), contactsController.createContactNote);
  app.delete("/api/contacts/notes/:noteId", requireAuth, requirePermission(PERMISSIONS.CONTACTS_EDIT), contactsController.deleteContactNote);
}