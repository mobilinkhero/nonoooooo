...
export const PERMISSIONS = {
  ...
  CANNED_RESPONSES_VIEW: "canned-responses:view",
  CANNED_RESPONSES_CREATE: "canned-responses:create",
  CANNED_RESPONSES_EDIT: "canned-responses:edit",
  CANNED_RESPONSES_DELETE: "canned-responses:delete",
} as const;
...
export const cannedResponsesRelations = relations(cannedResponses, ({ one }) => ({
  channel: one(channels, {
    fields: [cannedResponses.channelId],
    references: [channels.id],
  }),
  user: one(users, {
